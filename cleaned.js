...
console.log(songs)
    ...
    // if (results.contents && 
    //     results.contents.tabbedSearchResultsRenderer &&
    //     results.contents.tabbedSearchResultsRenderer.tabs &&
    //     results.contents.tabbedSearchResultsRenderer.tabs.length > 0) {
      
    //   // Attempting to extract songs - adjust this based on actual response structure
    //   console.log('\nSearch results:');
